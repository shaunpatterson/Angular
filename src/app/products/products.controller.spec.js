(function() {
    ...
    describe('ProductsController', function(){
        ...
        beforeEach(function() {
            ...
            bard.inject('$controller', '$log', '$q', 'ProductsService', '$rootScope');
        });
