...
### Getting up and running:
 ...
 - Implement the steps outlined below in a branch.  Use incremental commits as possible to show how you arrived ad your solution
...
Please perform each step in sequence, and commit them individually.  You are free to do smaller commits along the way, but just indicate in the commit message which commit contain the finished code for each step.  For example, the following flow would be fine:
 ...
 - Commit 1: ...
 - Commit 2: ...
 - Commit 3: Step 1 complete
 - Commit 4: ...
 - Commit 5: Step 2 complete
 - ... and so on
...
### Steps
 ...
 2. On the products page, render an simple unordered list of products using the `Products.getProducts()` method.  This should just be one line per product of "[styleNumber] - [displayName]".  Do not worry about any styling in this step.
